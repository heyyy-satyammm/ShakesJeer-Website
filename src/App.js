            ...
            <a href="#" className="close-overlay-btn">
             ...
             <div className="overlay-desc activated">
              <div className="container">
                <div className="button-effect">
                  <h2>Choose Your Semester!</h2>
                  <a className="effect effect-1 " href="#" title="Sem-1">
                    1
                  </a>
                  <a className="effect effect-1" href="#" title="Sem-2">
                    2
                  </a>
                  <a className="effect effect-1" href="#" title="Sem-3">
                    3
                  </a>
                  <a className="effect effect-1" href="#" title="Sem-4">
                    4
                  </a>
                  <a className="effect effect-1" href="#" title="Sem-5">
                    5
                  </a>
                  <a className="effect effect-1" href="#" title="Sem-6">
                    6
                  </a>
                  <a className="effect effect-1" href="#" title="Sem-7">
                    7
                  </a>
                  <a className="effect effect-1" href="#" title="Sem-8">
                    8
                  </a>
                </div>
              </div>
